    ...
    return (
        ...
        topNode={
          <Typography variant="h3">
            단순 예약판인 CRM을 넘어 <br/>
            <Keyword>유입과 마케팅 분석</Keyword> <Hidden smUp><br/></Hidden>그리고<Keyword> <Hidden smUp><br/></Hidden>상담, 내원, 결제까지</Keyword>
          </Typography>
        } 
        bottomNode={
          <Typography variant="h3">
           데이터를 기반으로하는 <Hidden smUp><br/></Hidden>MRM을 통해<br/>
            <b>병원의 저비용 고효율 운영을 <Hidden smUp><br/></Hidden>지금 시작해보세요!</b>
          </Typography>
        }
